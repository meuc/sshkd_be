...
// Start Class
if ( ! class_exists( 'Yogax_Image_Resize' ) ) {

    class Yogax_Image_Resize {
        ...
        public function __construct() {
            $this->yogax_retina_enabled = get_theme_mod( 'yogax_retina', false );
            $this->yogax_retina_enabled = apply_filters( 'yogax_image_resize_retina', $this->yogax_retina_enabled );
        }
         ...
         */
        public function yogax_process( $args ) {


            // Args must be an array
            if ( ! is_array( $args ) ) {
                print_r( esc_attr__('Fatal Error: Image resize args are not an array, you must update your template files.', 'yogax' ));
                return false;
            }
            ...
            if ( $crop && get_theme_mod( 'yogax_image_resizing', true ) ) {
                if ( is_array( $crop ) ) {
...
// Helper function for resizing images using the Yogax_Image_Resize class
if ( ! function_exists( 'yogax_image_resize' ) ) {
    function yogax_image_resize( $args ) {
        $class = new Yogax_Image_Resize;
        return $class->yogax_process( $args );
    }
}