<?php
function yogax_demo_import_files() {
	return array(
		array(
			'import_file_name'             => 'Yogax Demo Import',
			...
			'import_preview_image_url'     => 'http://ttdemo2.wpengine.com/yogax/wp-content/uploads/sites/3/2017/01/screenshot.jpg',
		)
	);
}
add_filter( 'pt-ocdi/import_files', 'yogax_demo_import_files' );

function yogax_after_demo_import_setup($selected_import) {
...
add_action( 'pt-ocdi/after_import', 'yogax_after_demo_import_setup' );